...
_SEED_DATA = [
    ...
    ('Sjokoladebiter',    'Snacks og Gotteri', None, True, False),
    ('Popcornkjerner',    'Snacks og Gotteri', None, True, False),
    ('Tørkede tranebær',  'Snacks og Gotteri', None, True, False),
    ('Tørkede fiken',     'Snacks og Gotteri', None, True, False),

    # ── Frukt og Grønt — ekstra ─────────────────────────────────────────────
    ('Stangselleri',      'Frukt og Grønt',  10, False, False),
    ('Rødkål',            'Frukt og Grønt',  14, False, False),
    ('Grønnkål',          'Frukt og Grønt',   7, False, False),
    ('Palmekål',          'Frukt og Grønt',   7, False, False),
    ('Spidskål',          'Frukt og Grønt',  14, False, False),
    ('Mangold',           'Frukt og Grønt',   5, False, False),
    ('Asparges',          'Frukt og Grønt',   5, False, False),
    ('Sukkererter',       'Frukt og Grønt',   5, False, False),
    ('Reddik',            'Frukt og Grønt',  14, False, False),
    ('Gressløk',          'Frukt og Grønt',   7, False, False),
    ('Estragon',          'Frukt og Grønt',   7, False, False),
    ('Salvie',            'Frukt og Grønt',   7, False, False),
    ('Melon',             'Frukt og Grønt',   7, False, False),
    ('Vannmelon',         'Frukt og Grønt',   7, False, False),
    ('Kiwi',              'Frukt og Grønt',  10, False, False),
    ('Grapefrukt',        'Frukt og Grønt',  14, False, False),
    ('Rabarbra',          'Frukt og Grønt',   7, False, False),
    ('Kirsebær',          'Frukt og Grønt',   5, False, False),
    ('Plommer',           'Frukt og Grønt',   5, False, False),
    ('Granateple',        'Frukt og Grønt',  14, False, False),
    ('Papaya',            'Frukt og Grønt',   5, False, False),
    ('Fiken',             'Frukt og Grønt',   5, False, False),
    ('Kokosnøtt',         'Frukt og Grønt',  14, False, False),
    ('Physalis',          'Frukt og Grønt',  10, False, False),

    # ── Kjøtt og Fisk — ekstra ──────────────────────────────────────────────
    ('Entrecôte',         'Kjøtt og Fisk',    3, False, False),
    ('Biff',              'Kjøtt og Fisk',    3, False, False),
    ('Hel kylling',       'Kjøtt og Fisk',    3, False, False),
    ('Kyllingklubbe',     'Kjøtt og Fisk',    3, False, False),
    ('Kyllingvinger',     'Kjøtt og Fisk',    3, False, False),
    ('Strimlet kylling',  'Kjøtt og Fisk',    3, False, False),
    ('Kalvekjøtt',        'Kjøtt og Fisk',    3, False, False),
    ('Elgkjøtt',          'Kjøtt og Fisk',    3, False, False),
    ('Hjortekjøtt',       'Kjøtt og Fisk',    3, False, False),
    ('Reinsdyrkjøtt',     'Kjøtt og Fisk',    3, False, False),
    ('Røkt laks',         'Kjøtt og Fisk',   10, False, False),
    ('Gravlaks',          'Kjøtt og Fisk',    5, False, False),
    ('Torskefilet',       'Kjøtt og Fisk',    2, False, False),
    ('Ørret',             'Kjøtt og Fisk',    2, False, False),
    ('Kamskjell',         'Kjøtt og Fisk',    1, False, False),
    ('Fiskekaker',        'Kjøtt og Fisk',    3, False, False),
    ('Klippfisk',         'Kjøtt og Fisk',   90, False, False),
    ('Salami',            'Kjøtt og Fisk',   14, False, False),
    ('Leverpostei',       'Kjøtt og Fisk',    5, False, False),
    ('Sardiner',          'Kjøtt og Fisk',  None, True,  False),
    ('Sild',              'Kjøtt og Fisk',  None, True,  False),
    ('Krabbe',            'Kjøtt og Fisk',    2, False, False),

    # ── Egg og Meieriprodukter — ekstra ─────────────────────────────────────
    ('Kvarg',             'Egg og Meieriprodukter', 14, False, False),
    ('Skyr',              'Egg og Meieriprodukter', 21, False, False),
    ('Kefir',             'Egg og Meieriprodukter', 21, False, False),
    ('Rømmekolle',        'Egg og Meieriprodukter', 10, False, False),
    ('Jarlsberg',         'Egg og Meieriprodukter', 30, False, False),
    ('Norvegia',          'Egg og Meieriprodukter', 30, False, False),
    ('Emmentaler',        'Egg og Meieriprodukter', 30, False, False),
    ('Gouda',             'Egg og Meieriprodukter', 30, False, False),
    ('Ricotta',           'Egg og Meieriprodukter',  7, False, False),
    ('Smøreost',          'Egg og Meieriprodukter', 21, False, False),
    ('Eggeplomme',        'Egg og Meieriprodukter',  3, False, False),
    ('Eggehvite',         'Egg og Meieriprodukter',  3, False, False),

    # ── Hermetikk og Tørrvarrer — ekstra ────────────────────────────────────
    ('Couscous',          'Hermetikk og Tørrvarrer', None, True,  False),
    ('Bulgur',            'Hermetikk og Tørrvarrer', None, True,  False),
    ('Quinoa',            'Hermetikk og Tørrvarrer', None, True,  False),
    ('Polenta',           'Hermetikk og Tørrvarrer', None, True,  False),
    ('Brun ris',          'Hermetikk og Tørrvarrer', None, True,  False),
    ('Rugmel',            'Hermetikk og Tørrvarrer', None, True,  False),
    ('Mandelmel',         'Hermetikk og Tørrvarrer', None, True,  False),
    ('Havremel',          'Hermetikk og Tørrvarrer', None, True,  False),
    ('Rismel',            'Hermetikk og Tørrvarrer', None, True,  False),
    ('Lønnesirup',        'Hermetikk og Tørrvarrer', None, True,  False),
    ('Agavesirup',        'Hermetikk og Tørrvarrer', None, True,  False),
    ('Sirup',             'Hermetikk og Tørrvarrer', None, True,  False),
    ('Vanilje',           'Hermetikk og Tørrvarrer', None, True,  False),
    ('Kondensert melk',   'Hermetikk og Tørrvarrer', None, True,  False),
    ('Havremelk',         'Hermetikk og Tørrvarrer',  7,   False, False),
    ('Rismelk',           'Hermetikk og Tørrvarrer',  7,   False, False),
    ('Kokosflak',         'Hermetikk og Tørrvarrer', None, True,  False),
    ('Pinjekjerner',      'Hermetikk og Tørrvarrer', None, True,  False),
    ('Hasselnøtter',      'Hermetikk og Tørrvarrer', None, True,  False),
    ('Solsikkekjerner',   'Hermetikk og Tørrvarrer', None, True,  False),
    ('Gresskarkjerner',   'Hermetikk og Tørrvarrer', None, True,  False),
    ('Chiafrø',           'Hermetikk og Tørrvarrer', None, True,  False),
    ('Linfrø',            'Hermetikk og Tørrvarrer', None, True,  False),
    ('Tørkede tranebær',  'Hermetikk og Tørrvarrer', None, True,  False),
    ('Panko',             'Hermetikk og Tørrvarrer', None, True,  False),
    ('Cornflakes',        'Hermetikk og Tørrvarrer', None, True,  False),
    ('Havregrøt',         'Hermetikk og Tørrvarrer', None, True,  False),
    ('Rugbrød',           'Hermetikk og Tørrvarrer',  7,   False, False),
    ('Naanbrød',          'Hermetikk og Tørrvarrer',  3,   False, False),
    ('Pitabrød',          'Hermetikk og Tørrvarrer',  5,   False, False),
    ('Risnudler',         'Hermetikk og Tørrvarrer', None, True,  False),
    ('Glassnudler',       'Hermetikk og Tørrvarrer', None, True,  False),
    ('Sylteagurk',        'Hermetikk og Tørrvarrer', None, True,  False),
    ('Kapers',            'Hermetikk og Tørrvarrer', None, True,  False),
    ('Sorte oliven',      'Hermetikk og Tørrvarrer', None, True,  False),
    ('Grønne oliven',     'Hermetikk og Tørrvarrer', None, True,  False),
    ('Ansjos',            'Hermetikk og Tørrvarrer', None, True,  False),
    ('Soltørkede tomater','Hermetikk og Tørrvarrer', None, True,  False),
    ('Rød currypasta',    'Hermetikk og Tørrvarrer', None, True,  False),
    ('Grønn currypasta',  'Hermetikk og Tørrvarrer', None, True,  False),
    ('Misopaste',         'Hermetikk og Tørrvarrer', None, True,  False),
    ('Teriyakisaus',      'Hermetikk og Tørrvarrer', None, True,  False),
    ('Sambal oelek',      'Hermetikk og Tørrvarrer', None, True,  False),
    ('Pepperrot',         'Hermetikk og Tørrvarrer', None, True,  False),
    ('Grovkornet sennep', 'Hermetikk og Tørrvarrer', None, True,  False),
    ('Tofu',              'Hermetikk og Tørrvarrer',  7,   False, False),
    ('Tempeh',            'Hermetikk og Tørrvarrer',  7,   False, False),

    # ── Krydder — ekstra ────────────────────────────────────────────────────
    ('Garam masala',      'Krydder', None, True, False),
    ('Ras el hanout',     'Krydder', None, True, False),
    ('Sumak',             'Krydder', None, True, False),
    ('Korianderpulver',   'Krydder', None, True, False),
    ('Anisfrø',           'Krydder', None, True, False),
    ('Bukkehornsfrø',     'Krydder', None, True, False),
    ('Urtesalt',          'Krydder', None, True, False),
    ('Valmuefrø',         'Krydder', None, True, False),
    ('Røkt salt',         'Krydder', None, True, False),
    ('Laksekrydder',      'Krydder', None, True, False),
    ('Italiensk krydder', 'Krydder', None, True, False),
    ('Herbes de Provence','Krydder', None, True, False),

    # ── Frysevarer — ekstra ─────────────────────────────────────────────────
    ('Frossen brokkoli',    'Frysevarer', 365, False, False),
    ('Frossen blomkål',     'Frysevarer', 365, False, False),
    ('Frosne jordbær',      'Frysevarer', 365, False, False),
    ('Frosne bønner',       'Frysevarer', 365, False, False),
    ('Frosne pommes frites','Frysevarer', 180, False, False),
    ('Frossent brød',       'Frysevarer',  90, False, False),
    ('Frosne rosenkål',     'Frysevarer', 365, False, False),

    # ── Misc ────────────────────────────────────────────────────────────────
    ('Hvitvin',           'Misc', None, False, False),
    ('Øl',                'Misc', None, False, False),
    ('Konjakk',           'Misc', None, False, False),
    ('Sitronsaft',        'Misc', None, False, False),
    ('Appelsinjuice',     'Misc', None, False, False),
    ('Eplejuice',         'Misc', None, False, False),
]
